...
def procesar_mensaje(data_mensaje, sock):
    ...
    tokens = data.split(":")
    if tokens[0] == 'list':
        query = ("SELECT id, nombre, descripcion, precio, stock, fecha_vencimiento FROM Productos WHERE stock < 10 ORDER BY stock ASC;")
...
def main():
    ...
    mensaje = "00010sinitstock"  # Mensaje a enviar
